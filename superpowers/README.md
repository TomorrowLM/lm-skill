...
using-superpowers → brainstorming → writing-plans[+gitnexus] → subagent-driven-development[+gitnexus] 或 executing-plans[+gitnexus] → verification-before-completion → requesting-code-review[+gitnexus] → receiving-code-review → git-finishing-development-branch
