...
**官方指南：** Anthropic 官方的技能编写最佳实践请参见 `references/anthropic-best-practices.md`。该文档提供了补充本技能 TDD 导向方法的额外模式和指南。
...
3. `references/` 中的文件按主题拆分，例如 `references/examples.md`、`references/review-checklist.md`
...
参见 `references/graphviz-conventions.dot` 了解 graphviz 样式规则。
...
**心理学说明：** 理解说服技巧为什么有效有助于你系统性地应用它们。参见 `references/persuasion-principles.md` 了解研究基础（Cialdini, 2021; Meincke et al., 2025），涵盖权威、承诺、稀缺、社会认同和归属原则。
...
**测试方法论：** 参见 `references/testing-skills-with-subagents.md` 了解完整的测试方法：
- 如何编写压力场景
- 压力类型（时间、沉没成本、权威、疲惫）
- 系统地堵住漏洞
- 元测试技巧
